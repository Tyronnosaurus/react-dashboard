...
import { mockTransactions, mockTrasactions } from "../../data/mockData";
    ...
    return(
        <Box margin="20px">
            ...
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="140px" gap="20px">
                ...
                <Box gridColumn="span 3" backgroundColor={colors.primary[400]}
                        display="flex" alignItems="center" justifyContents="center">
                    <StatBox title="135,775" subtitle="Sales Obtained" progress="0.5" increase="+21%" 
                                icon={
                ...
                <Box gridColumn="span 3" backgroundColor={colors.primary[400]}
                        display="flex" alignItems="center" justifyContents="center">
                    <StatBox title="32,116" subtitle="New Clients" progress="0.3" increase="+15%" 
                                icon={
                ...
                <Box gridColumn="span 3" backgroundColor={colors.primary[400]}
                        display="flex" alignItems="center" justifyContents="center">
                    <StatBox title="1,456,789" subtitle="Traffic Inbound" progress="0.8" increase="+43%" 
                             icon={
                ...
                <Box gridColumn="span 4" gridRow="span 2" backgroundColor={colors.primary[400]} p="30px">
                    ...
                    <Box display="flex" flexDirection="column" alignItems="center" mt="25px">
                        <ProgressCircle size="125" progress="0.65"/>
                        <Typography variant="h5" color={colors.greenAccent[500]} sx={{mt:"15px"}}>
                            $48,912 revenue generated
                        </Typography>
